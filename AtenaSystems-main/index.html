...
<body>
        ...
        <nav class="navbar navbar-expand-lg ">
            <div class="container-fluid">
                <a onclick="pageScrollatenasystems()" class="navbar-brand">
                    <img src="img/LogoAtenasPreta.png" alt="Atena Systems" style="max-width: 190px;"
                        class="logo">
                </a>
    ...
    <section class="home-page">
        ...
        <div>
            <img src="img/LogoEAtenas.png" alt="" style="max-width:200px;" class="logo">
        </div >
...
<script>
        window.addEventListener("scroll", function() {
            ...
            if (scrollPosition > alturaMudancaDeCor) {
                ...
                navbar.style.backgroundColor = "#e5eaf5"; 
            } else {
